    ...
    <scroll-view class="page-scroll" scroll-y :show-scrollbar="false">
      ...
      <view class="quick-grid">
        ...
        <view class="quick-action location" @tap="getLocation">
          <view class="quick-icon emoji-icon">📍</view>
          <view><text class="quick-title">获取位置</text></view>
...
.title-block { padding: 62rpx 40rpx 30rpx; }
...
.section-title-local { display: block; margin: 44rpx 40rpx 18rpx; font-size: calc(var(--font-section) - 8rpx); font-weight: 700; }
.quick-grid { display: grid; gap: 14rpx; padding: 0 36rpx; }
.quick-action { display: grid; min-height: 100rpx; grid-template-columns: 58rpx minmax(0, 1fr) auto; align-items: center; gap: 16rpx; padding: 18rpx 22rpx; box-sizing: border-box; border-radius: 26rpx; box-shadow: 0 12rpx 40rpx rgba(31, 28, 37, 0.07); }
...
.safety-step { display: flex; min-height: 178rpx; flex-direction: column; padding: 22rpx 18rpx; box-sizing: border-box; border: 1rpx solid #ebe9ed; border-radius: 24rpx; box-shadow: 0 12rpx 40rpx rgba(31, 28, 37, 0.07); }
...
.report-guide { margin: 34rpx 36rpx 0; padding: 28rpx; border-radius: 28rpx; background: #f3f1ff; box-shadow: 0 12rpx 40rpx rgba(31, 28, 37, 0.07); }
